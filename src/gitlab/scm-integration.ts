/**
 * GitLabSCMIntegration — implements SCMIntegration for GitLab.
 *
 * Encapsulates GitLab SCM credential resolution and validation
...
export class GitLabSCMIntegration implements SCMIntegration {
	readonly type = 'gitlab';
	readonly category = 'scm' as const;

	/**
	 * Check if GitLab SCM integration is configured for a project.
	 ...
	 * GitLab credential scope. Follows the same pattern as GitHubSCMIntegration.withCredentials().
	 */
